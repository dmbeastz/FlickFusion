...
movies_info_data = [
    {"title": "The Amazing Spider-Man", "description": "After Peter Parker is bitten by a genetically altered spider, he gains newfound, spider-like powers and ventures out to save the city from the machinations of a mysterious reptilian foe.", "parental_guide": "PG-13", "genre": "Action", "runtime": 140, "year": 2014},
...
for series_info_data_item in series_info_data:
    ...
    if series:
        series_info = SeriesInfo(series_id=series.id, description=series_info_data_item['description'], parental_guide=series_info_data_item['parental_guide'], genre=series_info_data_item['genre'], seasons=series_info_data_item['seasons'], episodes=series_info_data_item['episodes'], runtime=series_info_data_item['runtime'], year=series_info_data_item['year'])
